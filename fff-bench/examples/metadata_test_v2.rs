...
async fn main() -> Result<()> {
    ...
    match args.command {
        Some(Commands::Gen) => {
            for num_columns in [
                2333, 10, 20, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 5_000, 10000,
                20_000, 50000, 100_000,
            ] {
                for num_rows in [8] {
                    ...
                    let parquet = std::fs::OpenOptions::new()
                        .read(true)
                        .write(true)
                        .create(true)
            ...
            match format.to_lowercase().as_str() {
                "fff" => {
                    ...
                    let mut reader = FileReaderV2Builder::new(Arc::new(fff))
                        ...
                        .build()
                        .unwrap();
                    let result = reader.read_file().unwrap();
                    println!(
